...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team skills and compete in interschool soccer matches",
    ...
    "Drama Society": {
        "description": "Rehearse plays, improv, and perform theatrical pieces",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["charlotte@mergington.edu", "oliver@mergington.edu"]
    },
    "Science Olympiad": {
